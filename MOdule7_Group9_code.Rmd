...
To further answer the question:Is there a significant shift between θmax between the control and fatigue FL relationships? We need to construct polynomial models to estimate the maximum force 

```{r  assess second, third, and fourth order polynomial models using AIC , echo= FALSE}
...
```{r, filter the model by finding by the lowest AICs, echo=FALSE}
